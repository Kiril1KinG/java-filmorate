...
class UserDbStorageTest {
    ...
    public void testCrud() {
        User newUser = new User(1, "user@email.ru", "kirillking01", "Kirill Sharapov", LocalDate.of(2004, 7, 2), new HashSet<>());
        ...
        User newUser2 = new User(2, "user2@yandex.ru", "semenchuksu", "Stanislav Semenchuk", LocalDate.of(1990, 1, 1), new HashSet<>());
